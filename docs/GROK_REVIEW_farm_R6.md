...
- **版本錨**：`r59-20260714-1`（`package.json`／`index.html`／`sw.js`／`manifest`／`ui.js` fallback／e2e 斷言對齊）
...
| `package.json`／`index.html`／`sw.js`／`manifest` | 版本 `r59-20260714-1` |
