...
console.log("\n== 13b. Stage 5/12：修橋解鎖東林 + 採集鏈 + 商人回報 ==");
{
  ...
  assert(herbTile && mushroomTile && herbTile.forage && mushroomTile.forage, "東林有 2 個限定採集點");
  ...
  assert(afterUnlockPool.indexOf("forest_herb") !== -1 && afterUnlockPool.indexOf("glow_mushroom") !== -1,
    "回報後東林採集物進入訂單/委託池");
}
